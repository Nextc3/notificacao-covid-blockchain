...
func (c *ContratoInteligente) gerarObjetoTeste() (entidade.Notificacao, entidade.Notificacao) {
	n1 := entidade.Notificacao{
		...
		/*
			IdNotificador:             1,
			CpfNotificador:            "123456645-09",
			NomeNotificador:           "Caio Costa",
			OcupacaoNotificador:       "médico",
			RegistroNotificador:       "1467456",
			...
			Estrategia:                "sintomatico",
			LocalizacaoTeste:          "escola",
			DataNotificacao:           "05/05/2022",
			Sintomas:                  "assintomatico",
			Condicoes:                 "Doenças cardíacas crônicas",
			Vacinas:                   "1 pfizer,2 pfizer,3 pfizer",
			TipoDeTeste:               "rt-pcr",
	...
	n2 := entidade.Notificacao{
		...
		/*
			IdNotificador:             1,
			CpfNotificador:            "123456780-09",
			NomeNotificador:           "Garibaldo",
			OcupacaoNotificador:       "médico",
			RegistroNotificador:       "123456",
			EhProfissionalDeSaude:     false,
			EhProfissionalDeSeguranca: false,
